...
import com.example.multitenant.dtos.organizations.OrgTransferOwnershipDTO;
...
public class OrgDashboardController {
    ...
    public ResponseEntity<Object> updateOrganization(@ValidateNumberId @PathVariable Integer id, @Valid @RequestBody OrgUpdateDTO dto) {
    ...
    public ResponseEntity<Object> transferOwnership(@Valid @RequestBody OrgTransferOwnershipDTO dto) {
