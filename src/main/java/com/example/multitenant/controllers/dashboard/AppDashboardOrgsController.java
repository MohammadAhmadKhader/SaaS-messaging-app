...
public class AppDashboardOrgsController {
    ...
    public ResponseEntity<Object> getOrganizationWithUsersById(@HandlePage Integer page, @HandleSize Integer size, @PathVariable(name = "id") Integer organizationId) {
        ...
        var orgView = new OrgWithUserRolesViewDTO(org);
    ...
    public ResponseEntity<Object> createOrganization(@Valid @RequestBody OrgCreateDTO dto) {
